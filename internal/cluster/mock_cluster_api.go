...
// SetConnectivityNajorityGroupsForCluster mocks base method
func (m *MockAPI) SetConnectivityNajorityGroupsForCluster(c *common.Cluster, db *gorm.DB) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetConnectivityNajorityGroupsForCluster", c, db)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetConnectivityNajorityGroupsForCluster indicates an expected call of SetConnectivityNajorityGroupsForCluster
func (mr *MockAPIMockRecorder) SetConnectivityNajorityGroupsForCluster(c, db interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetConnectivityNajorityGroupsForCluster", reflect.TypeOf((*MockAPI)(nil).SetConnectivityNajorityGroupsForCluster), c, db)
}
